# -*- coding: utf-8 -*-
"""NBA Playoff Rank Prediction (RNN Model)

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1ERmXPQefLM_ES_y-BlH5Q1byij2lFmQW
"""
    ...
    for season in seasons:
        ...
        for epoch in range(num_epochs):
            ...
            for batch in pbar:
                ...
                num_batches += 1
                pbar.set_postfix({'loss': loss.item():.4f}) # Update progress bar description
        ...
        # Use scipy.stats.rankdata for robust ranking (handles ties)
